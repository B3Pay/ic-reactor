...
- **Retries.** When the query sets no `retry` of its own, an update method
  ...
  config, or in `fetch` options — wins.
...
| ----------------------------------------------------------------- | ----------------------------------------------------------------------- | --------------------------------------------------- |
| The query itself (hook option, factory config, `fetch` options)   | used as given                                                           | used as given                                       |
...
| Nothing                                                           | TanStack's default: 3 retries in a browser for a hook, none for `fetch` | `SysTransient` only, up to 3 times in a browser     |
