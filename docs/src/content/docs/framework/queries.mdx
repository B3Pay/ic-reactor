...
A skipped query is keyed by its method alone, the prefix of the key its
arguments will give it. The suspense hooks and factories do not take
`skipToken`, since a suspense query has to be able to run.
