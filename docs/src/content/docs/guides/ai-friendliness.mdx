...
## Agent Skills (IC Reactor Skills Repo)

Installable IC Reactor skills are maintained in the separate skills mono-repo:

- [`B3Pay/ic-reactor-skills`](https://github.com/B3Pay/ic-reactor-skills)
...
If you use **GitHub Copilot**, install the IC Reactor skills from [`B3Pay/ic-reactor-skills`](https://github.com/B3Pay/ic-reactor-skills) in addition to using the repository docs and examples.
