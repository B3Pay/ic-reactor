...
- [Queries](/v4/framework/queries) — Type-safe query patterns
- [Mutations](/v4/framework/mutations) — Type-safe mutation patterns
- [Error Handling](/v4/guides/error-handling) — Type-safe error handling
