...
| `@ic-reactor/react`       | React hooks, factories, and React setup helpers       | [![npm](https://img.shields.io/npm/v/@ic-reactor/react)](https://www.npmjs.com/package/@ic-reactor/react)             |
| `@ic-reactor/auth`        | Non-React Internet Identity auth and attributes       | [![npm](https://img.shields.io/npm/v/@ic-reactor/auth)](https://www.npmjs.com/package/@ic-reactor/auth)               |
| `@ic-reactor/auth-react`  | React hooks for auth managers                         | [![npm](https://img.shields.io/npm/v/@ic-reactor/auth-react)](https://www.npmjs.com/package/@ic-reactor/auth-react)   |
...
| `@ic-reactor/codegen`     | Shared generator pipeline for CLI and Vite plugin     | [![npm](https://img.shields.io/npm/v/@ic-reactor/codegen)](https://www.npmjs.com/package/@ic-reactor/codegen)         |
| `@ic-reactor/cli`         | Command-line declaration and hook generation          | [![npm](https://img.shields.io/npm/v/@ic-reactor/cli)](https://www.npmjs.com/package/@ic-reactor/cli)                 |
| `@ic-reactor/vite-plugin` | Vite watch-mode generation and local env injection    | [![npm](https://img.shields.io/npm/v/@ic-reactor/vite-plugin)](https://www.npmjs.com/package/@ic-reactor/vite-plugin) |

<Aside type="note">
  Looking for **v2 documentation**? The legacy docs are available at
  [ic-reactor.b3pay.net/ic-reactor](https://ic-reactor.b3pay.net/ic-reactor/).
</Aside>
