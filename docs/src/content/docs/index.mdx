...
<CardGrid>
  <LinkCard
    ...
    href="/v4/getting-started/installation"
  />
  <LinkCard
    title="Quick Start"
    description="Build your first IC Reactor integration"
    href="/v4/getting-started/quick-start"
  />
  <LinkCard
    title="React Setup"
...
| ------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| `@ic-reactor/core`        | Framework-agnostic runtime with ClientManager, Reactor, and cache helpers   | [![npm](https://img.shields.io/npm/v/@ic-reactor/core)](https://www.npmjs.com/package/@ic-reactor/core)               |
| `@ic-reactor/react`       | React hooks, factories, setup helpers, Internet Identity auth, and attributes | [![npm](https://img.shields.io/npm/v/@ic-reactor/react)](https://www.npmjs.com/package/@ic-reactor/react)             |
| `@ic-reactor/candid`      | Dynamic Candid fetching, parsing, metadata reactors, and display adapters   | [![npm](https://img.shields.io/npm/v/@ic-reactor/candid)](https://www.npmjs.com/package/@ic-reactor/candid)           |
| `@ic-reactor/parser`      | WASM Candid parser for local compilation and generated declarations         | [![npm](https://img.shields.io/npm/v/@ic-reactor/parser)](https://www.npmjs.com/package/@ic-reactor/parser)           |
| `@ic-reactor/codegen`     | Shared generator pipeline for the CLI and Vite plugin                       | [![npm](https://img.shields.io/npm/v/@ic-reactor/codegen)](https://www.npmjs.com/package/@ic-reactor/codegen)         |
| `@ic-reactor/cli`         | Command-line declaration and reactor generation                             | [![npm](https://img.shields.io/npm/v/@ic-reactor/cli)](https://www.npmjs.com/package/@ic-reactor/cli)                 |
| `@ic-reactor/vite-plugin` | Vite watch-mode generation and local environment injection                  | [![npm](https://img.shields.io/npm/v/@ic-reactor/vite-plugin)](https://www.npmjs.com/package/@ic-reactor/vite-plugin) |

<Aside type="note">
  Looking for **v2 documentation**? The legacy docs are available at
  [ic-reactor.b3pay.net/v2](https://ic-reactor.b3pay.net/v2/).
</Aside>
