...
It uses the shared [`@ic-reactor/codegen`](/v4/packages/codegen) pipeline, so
...
- **[Codegen in Action](/v4/examples/codegen-in-action)**: Comparison between CLI and Vite plugin generated code.
- **[TypeScript Demo](/v4/examples/typescript-demo)**: Using the CLI to generate pure TypeScript reactors without React.

## See Also

- [@ic-reactor/codegen](/v4/packages/codegen) — Shared generation pipeline
- [@ic-reactor/vite-plugin](/v4/packages/vite-plugin) — Automatic generation during Vite development
