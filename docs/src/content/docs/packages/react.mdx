...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Build reactors once per mounted tree, as a server-rendered app needs, with typed hooks from useReactor()."
    href="/v3/reference/createreactorprovider"
  />
  <LinkCard
...
- [Testing](/v3/guides/testing) — Component and hook tests against a fake
  replica, with `@ic-reactor/react/testing`
