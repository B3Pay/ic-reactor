...
[`@ic-reactor/codegen`](/v4/packages/codegen) pipeline inside Vite. It
...
cookie used by
[`ClientManager`](/v4/reference/clientmanager).
...
<Aside type="tip">
  ...
  [CLI](/v4/packages/cli) when you want explicit generation in non-Vite or CI
  workflows.
</Aside>

## Examples

- [Vite Plugin Demo](/v4/examples/vite-plugin)
- [Vite Environment Variables](/v4/examples/vite-env)
- [Codegen in Action](/v4/examples/codegen-in-action)

## See Also

- [@ic-reactor/codegen](/v4/packages/codegen)
