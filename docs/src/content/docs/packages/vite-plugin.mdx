...
- **[Vite Plugin Demo](/ic-reactor/v3/examples/vite-plugin)**: Basic usage of the Vite plugin for automatic hook generation.
- **[Vite Environment Variables](/ic-reactor/v3/examples/vite-env)**: Using the plugin to automatically inject canister IDs and root keys.
- **[Codegen in Action](/ic-reactor/v3/examples/codegen-in-action)**: Comparison between Vite plugin and CLI output.
