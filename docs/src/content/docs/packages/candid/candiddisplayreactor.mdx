...
- [CandidReactor](/v4/packages/candid/candidreactor) — Dynamic Reactor without display transformations
- [DisplayReactor](/v4/reference/displayreactor) — Static Reactor with display transformations
- [CandidAdapter](/v4/packages/candid/candidadapter) — Low-level Candid utilities
