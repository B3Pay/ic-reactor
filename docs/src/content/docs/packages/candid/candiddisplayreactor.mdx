...
- [CandidReactor](/ic-reactor/v3/packages/candid/candidreactor) — Dynamic Reactor without display transformations
- [DisplayReactor](/ic-reactor/v3/reference/displayreactor) — Static Reactor with display transformations
