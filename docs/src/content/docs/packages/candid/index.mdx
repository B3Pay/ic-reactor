...
- [CandidDisplayReactor](/ic-reactor/v3/packages/candid/candiddisplayreactor) — Dynamic Reactor with display transformations
- [MetadataDisplayReactor](/ic-reactor/v3/packages/candid/metadatadisplayreactor) — Display Reactor with form & result metadata
- [FieldVisitor](/ic-reactor/v3/packages/candid/fieldvisitor) — Generate form field metadata from Candid IDL
