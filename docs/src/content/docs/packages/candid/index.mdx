...
<Aside type="note">
  Local parsing requires the [`@ic-reactor/parser`](/v4/packages/parser)
  package. It's recommended for production to reduce network latency.
</Aside>

## See Also

- [CandidReactor](/v4/packages/candid/candidreactor) — Full reference for CandidReactor
- [CandidDisplayReactor](/v4/packages/candid/candiddisplayreactor) — Dynamic Reactor with display transformations
- [MetadataReactor](/v4/packages/candid/metadatareactor) — Candid-native metadata reactor
- [MetadataDisplayReactor](/v4/packages/candid/metadatadisplayreactor) — Display Reactor with form & result metadata
- [CandidFormVisitor](/v4/packages/candid/fieldvisitor) — Generate form metadata with schema and UI hints
- [CandidAdapter](/v4/packages/candid/candidadapter) — Full reference for CandidAdapter
- [Reactor](/v4/reference/reactor) — Base Reactor class documentation
- [Error Handling](/v4/guides/error-handling) — Handle canister errors
