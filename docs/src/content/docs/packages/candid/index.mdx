...
- [MetadataReactor](/v3/packages/candid/metadatareactor) — Candid-native metadata reactor
- [MetadataDisplayReactor](/v3/packages/candid/metadatadisplayreactor) — Display Reactor with form & result metadata
- [CandidFormVisitor](/v3/packages/candid/fieldvisitor) — Generate form metadata with schema and UI hints
