...
<CardGrid>
  ...
  <Card title="CandidDisplayReactor" icon="star">
    Dynamic Reactor with automatic display type transformations (bigint →
    string)
  </Card>
  <Card title="MetadataDisplayReactor" icon="document">
    Display Reactor with visitor-based metadata for form building and result
    display
  </Card>
  <Card title="FieldVisitor" icon="list-format">
    Generate form field metadata from Candid IDL types for dynamic forms
  </Card>
...
| `FieldVisitor`           | Generate form field metadata from Candid IDL types         |
...
<Aside type="note">
  Local parsing requires the [`@ic-reactor/parser`](/v3/packages/parser)
  package. It's recommended for production to reduce network latency.
</Aside>

## See Also

- [CandidReactor](/v3/packages/candid/candidreactor) — Full reference for CandidReactor
- [CandidDisplayReactor](/v3/packages/candid/candiddisplayreactor) — Dynamic Reactor with display transformations
- [MetadataDisplayReactor](/v3/packages/candid/metadatadisplayreactor) — Display Reactor with form & result metadata
- [FieldVisitor](/v3/packages/candid/fieldvisitor) — Generate form field metadata from Candid IDL
- [CandidAdapter](/v3/packages/candid/candidadapter) — Full reference for CandidAdapter
- [Reactor](/v3/reference/reactor) — Base Reactor class documentation
