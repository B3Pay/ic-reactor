...
3. **Local Parser** — Use the optional [`@ic-reactor/parser`](/v4/packages/parser) for offline compilation
...
- [CandidReactor](/v4/packages/candid/candidreactor) — High-level dynamic Reactor
- [@ic-reactor/candid Overview](/v4/packages/candid/) — Package overview
- [@ic-reactor/parser](/v4/packages/parser) — Local WASM parser reference
- [Reactor](/v4/reference/reactor) — Base Reactor class
