...
- [REMOTE\_HOSTS](variables/REMOTE_HOSTS.md)
- [LOCAL\_HOSTS](variables/LOCAL_HOSTS.md)
- [IC\_HOST\_NETWORK\_URI](variables/IC_HOST_NETWORK_URI.md)
- [LOCAL\_HOST\_NETWORK\_URI](variables/LOCAL_HOST_NETWORK_URI.md)
- [IC\_INTERNET\_IDENTITY\_PROVIDER](variables/IC_INTERNET_IDENTITY_PROVIDER.md)
- [LOCAL\_INTERNET\_IDENTITY\_PROVIDER](variables/LOCAL_INTERNET_IDENTITY_PROVIDER.md)
