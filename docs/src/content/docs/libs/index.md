...
- [UseIdentityAttributesReturn](interfaces/UseIdentityAttributesReturn.md)
...
- [UseAuthReturn](interfaces/UseAuthReturn.md)
...
- [createIdentityAttributeHooks](functions/createIdentityAttributeHooks.md)
...
- [createAuthHooks](functions/createAuthHooks.md)
