...
By default, the plugin generates `src/lib/canisters/backend/index.generated.ts`
plus a stable `src/lib/canisters/backend/index.ts` wrapper, which you can then
import as:
