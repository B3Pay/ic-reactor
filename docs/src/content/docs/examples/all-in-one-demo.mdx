...
description: Complete example with optimistic updates and a Motoko backend
editUrl: false
---
...
- **Motoko Backend**: Includes a simple Motoko canister for posts and likes.
- **Generated Reactor**: The Vite plugin generates the backend's `DisplayReactor`
  and hooks into `src/declarations/backend/` from its Candid.
