...
<CardGrid>
  <LinkCard
    ...
    href="https://stackblitz.com/github/b3hr4d/ic-reactor-v3/tree/main/examples/query-demo?embed=1&theme=dark&file=src/reactor.ts"
  />
  <LinkCard
    title="View on GitHub"
    description="Browse the source code"
    href="https://github.com/b3hr4d/ic-reactor-v3/tree/main/examples/query-demo"
  />
</CardGrid>
...
<iframe
  src="https://stackblitz.com/github/b3hr4d/ic-reactor-v3/tree/main/examples/query-demo?embed=1&theme=dark&file=src/reactor.ts&view=preview"
