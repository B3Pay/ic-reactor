...
<CardGrid>
  <LinkCard
    ...
    href="https://stackblitz.com/github/b3hr4d/ic-reactor-v3/tree/main/examples/ckbtc-wallet?embed=1&theme=dark&file=src/App.tsx"
  />
  <LinkCard
    title="View on GitHub"
    description="Browse the source code"
    href="https://github.com/b3hr4d/ic-reactor-v3/tree/main/examples/ckbtc-wallet"
  />
</CardGrid>
...
<iframe
  src="https://stackblitz.com/github/b3hr4d/ic-reactor-v3/tree/main/examples/ckbtc-wallet?embed=1&theme=dark&file=src/App.tsx&view=preview"
