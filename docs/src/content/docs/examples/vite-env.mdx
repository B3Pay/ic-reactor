...
<CardGrid>
  <LinkCard
    ...
    href="https://stackblitz.com/github/b3pay/ic-reactor/tree/main/examples/vite-environment-variables/frontend?embed=1&theme=dark&file=vite.config.ts"
  />
  <LinkCard
...
<iframe
  src="https://stackblitz.com/github/b3pay/ic-reactor/tree/main/examples/vite-environment-variables/frontend?embed=1&theme=dark&file=vite.config.ts&view=preview"
