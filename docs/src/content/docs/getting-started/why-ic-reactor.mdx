...
| --------------------------- | -------------------------------- | -------------------------- |
| **Additional Bundle Size**  | **~16 KB** (on top of SDK)       | **~50+ KB** of custom code |
...
<Aside>
  ...
  layer in ~16 KB; building it yourself typically results in more code that does
  less.
</Aside>
...
| `blob` (≤512 bytes)   | `Uint8Array`                | `"1234..."` (hex)            | ✅         |
...
| **Additional Code**       | ~16 KB (battle-tested)             | ~50+ KB (untested custom code) |
