...
<Aside type="caution">
  ...
  [createSuspenseQuery](/v4/reference/factories/createsuspensequery) instead.
</Aside>

## See Also

- [createSuspenseQuery](/v4/reference/factories/createsuspensequery) — Suspense version
- [createInfiniteQuery](/v4/reference/factories/createinfinitequery) — Paginated queries
- [useActorQuery](/v4/reference/createactorhooks/useactorquery) — Direct hook usage
