...
<Aside type="caution">
  ...
  [createSuspenseInfiniteQuery](/v4/reference/factories/createsuspenseinfinitequery)
  instead.
</Aside>

## See Also

- [createSuspenseInfiniteQuery](/v4/reference/factories/createsuspenseinfinitequery) — Suspense version
- [useActorInfiniteQuery](/v4/reference/createactorhooks/useactorinfinitequery) — Direct hook usage
- [createQuery](/v4/reference/factories/createquery) — Non-paginated queries
