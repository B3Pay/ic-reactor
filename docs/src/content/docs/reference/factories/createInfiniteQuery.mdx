...
<Aside type="caution">
  ...
  [createSuspenseInfiniteQuery](/reference/factories/createsuspenseinfinitequery)
  instead.
</Aside>

## See Also

- [createSuspenseInfiniteQuery](/reference/factories/createsuspenseinfinitequery) — Suspense version
- [useActorInfiniteQuery](/reference/useactorinfinitequery) — Direct hook usage
- [createQuery](/reference/factories/createquery) — Non-paginated queries
