...
<CardGrid>
  ...
  <Card title="Centralized Config" icon="setting">
    Define `select`, `staleTime`, `refetchQueries` once — use everywhere
  </Card>
...
- [Queries Guide](/v3/guides/queries) — Query patterns
- [Mutations Guide](/v3/guides/mutations) — Mutation patterns
