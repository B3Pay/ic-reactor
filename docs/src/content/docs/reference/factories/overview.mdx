...
<CardGrid>
  <LinkCard
    ...
    href="/reference/factories/createquery"
  />
  <LinkCard
    title="createSuspenseQuery"
    description="Suspense-enabled query factory"
    href="/reference/factories/createsuspensequery"
  />
</CardGrid>
...
<CardGrid>
  <LinkCard
    ...
    href="/reference/factories/createmutation"
  />
</CardGrid>
...
<CardGrid>
  <LinkCard
    ...
    href="/reference/factories/createinfinitequery"
  />
  <LinkCard
    title="createSuspenseInfiniteQuery"
    description="Suspense-enabled infinite queries"
    href="/reference/factories/createsuspenseinfinitequery"
  />
</CardGrid>
...
- [Mutations Guide](/guides/mutations) — Mutation patterns
- [Reactor](/reference/reactor) — Understanding query keys
