...
<Aside type="caution">
  ...
  [createInfiniteQuery](/v4/reference/factories/createinfinitequery) if you need
  conditional fetching.
</Aside>

## See Also

- [createInfiniteQuery](/v4/reference/factories/createinfinitequery) — Non-Suspense version
- [createSuspenseQuery](/v4/reference/factories/createsuspensequery) — Non-paginated Suspense
- [useActorSuspenseInfiniteQuery](/v4/reference/createactorhooks/useactorsuspenseinfinitequery) — Direct hook
