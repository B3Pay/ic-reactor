...
<Aside type="caution">
  ...
  fetching, use [createQuery](/reference/factories/createquery) instead.
</Aside>
...
- [createQuery](/reference/factories/createquery) — Non-Suspense version
- [createSuspenseInfiniteQuery](/reference/factories/createsuspenseinfinitequery) — Suspense pagination
- [useActorSuspenseQuery](/reference/useactorsuspensequery) — Direct hook usage
