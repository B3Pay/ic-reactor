...
<Aside type="caution">
  ...
  fetching, use [createQuery](/v4/reference/factories/createquery) instead.
</Aside>
...
- [createQuery](/v4/reference/factories/createquery) — Non-Suspense version
- [createSuspenseInfiniteQuery](/v4/reference/factories/createsuspenseinfinitequery) — Suspense pagination
- [useActorSuspenseQuery](/v4/reference/createactorhooks/useactorsuspensequery) — Direct hook usage
