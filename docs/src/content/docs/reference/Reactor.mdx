...
<Aside type="note">
  ...
  use [DisplayReactor](/reference/displayreactor) instead.
</Aside>
...
See [DisplayReactor](/reference/displayreactor#validation) for full validation documentation.

## See Also

- [DisplayReactor](/reference/displayreactor) — Type transformations and validation
- [ClientManager](/reference/clientmanager) — Agent and auth management
- [createActorHooks](/reference/createactorhooks) — Create React hooks
- [Error Handling](/error-handling) — Handle canister errors
- [Type Safety](/type-safety) — Type system details
