...
<Aside type="note">
  ...
  use [DisplayReactor](/v4/reference/displayreactor) instead.
</Aside>
...
See [DisplayReactor](/v4/reference/displayreactor#validation) for full validation documentation.

## See Also

- [DisplayReactor](/v4/reference/displayreactor) — Type transformations and validation
- [ClientManager](/v4/reference/clientmanager) — Agent and auth management
- [createActorHooks](/v4/reference/createactorhooks/overview) — Create React hooks
