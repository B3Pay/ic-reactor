...
- [Reactor](/reference/reactor) — Canister reactor class
- [createAuthHooks](/reference/createauthhooks/overview) — Authentication hooks
- [Authentication](/authentication) — Auth patterns guide
