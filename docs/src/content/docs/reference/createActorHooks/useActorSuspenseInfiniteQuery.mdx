...
Same as [useActorInfiniteQuery](/v4/reference/createactorhooks/useactorinfinitequery) **except**:
...
- [useActorInfiniteQuery](/v4/reference/createactorhooks/useactorinfinitequery) — Regular infinite query
- [useActorSuspenseQuery](/v4/reference/createactorhooks/useactorsuspensequery) — Single suspense query
