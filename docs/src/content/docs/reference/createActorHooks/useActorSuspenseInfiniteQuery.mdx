...
Same as [useActorInfiniteQuery](/reference/useactorinfinitequery) **except**:
...
- [useActorInfiniteQuery](/reference/createactorhooks/useactorinfinitequery) — Regular infinite query
- [useActorSuspenseQuery](/reference/createactorhooks/useactorsuspensequery) — Single suspense query
- [Queries Guide](/guides/queries) — In-depth query patterns
