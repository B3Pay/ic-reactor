...
Same as [useActorInfiniteQuery](/v3/reference/createactorhooks/useactorinfinitequery) **except**:
...
| `getKeyArgs`           | `function`   | Narrows the args that key the cache, e.g. to drop the cursor (optional) |
...
- [useActorInfiniteQuery](/v3/reference/createactorhooks/useactorinfinitequery) — Regular infinite query
- [useActorSuspenseQuery](/v3/reference/createactorhooks/useactorsuspensequery) — Single suspense query
