...
- [useActorSuspenseInfiniteQuery](/reference/createactorhooks/useactorsuspenseinfinitequery) — Suspense version
- [useActorQuery](/reference/createactorhooks/useactorquery) — Regular queries
