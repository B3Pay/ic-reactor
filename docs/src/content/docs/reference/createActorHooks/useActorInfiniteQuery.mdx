...
- [useActorSuspenseInfiniteQuery](/v4/reference/createactorhooks/useactorsuspenseinfinitequery) — Suspense version
- [useActorQuery](/v4/reference/createactorhooks/useactorquery) — Regular queries
