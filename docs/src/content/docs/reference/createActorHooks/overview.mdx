...
| ----------------------------------------------------------------------------------------------- | ---- | ------------------------------------ |
| [`useActorQuery`](/v3/reference/createactorhooks/useactorquery)                                 | Hook | Query hook for fetching data         |
| [`useActorSuspenseQuery`](/v3/reference/createactorhooks/useactorsuspensequery)                 | Hook | Suspense-enabled query hook          |
| [`useActorMutation`](/v3/reference/createactorhooks/useactormutation)                           | Hook | Mutation hook for updates            |
| [`useActorMethod`](/v3/reference/createactorhooks/useactormethod)                               | Hook | Unified hook for queries & updates   |
| [`useActorInfiniteQuery`](/v3/reference/createactorhooks/useactorinfinitequery)                 | Hook | Infinite query hook for pagination   |
| [`useActorSuspenseInfiniteQuery`](/v3/reference/createactorhooks/useactorsuspenseinfinitequery) | Hook | Suspense-enabled infinite query hook |
...
- [useActorMutation](/v3/reference/createactorhooks/useactormutation) — Mutation hook reference
- [useActorSuspenseQuery](/v3/reference/createactorhooks/useactorsuspensequery) — Suspense query reference
- [useActorInfiniteQuery](/v3/reference/createactorhooks/useactorinfinitequery) — Infinite query reference
