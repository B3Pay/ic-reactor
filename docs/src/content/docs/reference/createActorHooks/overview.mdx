...
| -------------------------------------------------------------------------------------------- | ---- | ------------------------------------ |
| [`useActorQuery`](/reference/createactorhooks/useactorquery)                                 | Hook | Query hook for fetching data         |
| [`useActorSuspenseQuery`](/reference/createactorhooks/useactorsuspensequery)                 | Hook | Suspense-enabled query hook          |
| [`useActorMutation`](/reference/createactorhooks/useactormutation)                           | Hook | Mutation hook for updates            |
| [`useActorInfiniteQuery`](/reference/createactorhooks/useactorinfinitequery)                 | Hook | Infinite query hook for pagination   |
| [`useActorSuspenseInfiniteQuery`](/reference/createactorhooks/useactorsuspenseinfinitequery) | Hook | Suspense-enabled infinite query hook |
...
- [useActorMutation](/reference/createactorhooks/useactormutation) — Mutation hook reference
- [useActorSuspenseQuery](/reference/createactorhooks/useactorsuspensequery) — Suspense query reference
- [useActorInfiniteQuery](/reference/createactorhooks/useactorinfinitequery) — Infinite query reference
- [createAuthHooks](/reference/createauthhooks/overview) — Auth hooks factory
