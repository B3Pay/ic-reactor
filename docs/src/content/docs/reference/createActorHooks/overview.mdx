...
| ----------------------------------------------------------------------------------------------- | ---- | ------------------------------------ |
| [`useActorQuery`](/v4/reference/createactorhooks/useactorquery)                                 | Hook | Query hook for fetching data         |
| [`useActorSuspenseQuery`](/v4/reference/createactorhooks/useactorsuspensequery)                 | Hook | Suspense-enabled query hook          |
| [`useActorMutation`](/v4/reference/createactorhooks/useactormutation)                           | Hook | Mutation hook for updates            |
| [`useActorMethod`](/v4/reference/createactorhooks/useactormethod)                               | Hook | Unified hook for queries & updates   |
| [`useActorInfiniteQuery`](/v4/reference/createactorhooks/useactorinfinitequery)                 | Hook | Infinite query hook for pagination   |
| [`useActorSuspenseInfiniteQuery`](/v4/reference/createactorhooks/useactorsuspenseinfinitequery) | Hook | Suspense-enabled infinite query hook |
...
import { authentication, backend } from "./index"
...
- [useActorQuery](/v4/reference/createactorhooks/useactorquery) — Query hook reference
- [useActorMutation](/v4/reference/createactorhooks/useactormutation) — Mutation hook reference
- [useActorSuspenseQuery](/v4/reference/createactorhooks/useactorsuspensequery) — Suspense query reference
- [useActorInfiniteQuery](/v4/reference/createactorhooks/useactorinfinitequery) — Infinite query reference
