...
Same as [useActorQuery](/reference/createactorhooks/useactorquery) **except**:
...
- [useActorQuery](/reference/createactorhooks/useactorquery) — Regular query hook
- [useActorSuspenseInfiniteQuery](/reference/createactorhooks/useactorsuspenseinfinitequery) — Suspense pagination
