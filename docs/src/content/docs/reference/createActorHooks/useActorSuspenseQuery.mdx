...
Same as [useActorQuery](/v4/reference/createactorhooks/useactorquery) **except**:
...
- [useActorQuery](/v4/reference/createactorhooks/useactorquery) — Regular query hook
- [useActorSuspenseInfiniteQuery](/v4/reference/createactorhooks/useactorsuspenseinfinitequery) — Suspense pagination
- [Queries Guide](/v4/framework/queries) — In-depth query patterns
- [createActorHooks](/v4/reference/createactorhooks/overview) — Creating hooks
