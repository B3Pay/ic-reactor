...
<Aside type="tip">
  ...
  Handling](/ic-reactor/v3/error-handling) guide.
</Aside>
...
- [Type Safety](/ic-reactor/v3/type-safety) — Type system details
...
- [Error Handling](/ic-reactor/v3/error-handling) — Handle validation and canister errors
