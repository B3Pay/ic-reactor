...
- [Authentication Guide](/v3/authentication) — In-depth auth patterns
- [useAuth](/v3/reference/createauthhooks/useauth) — Main auth hook reference
- [createActorHooks](/v3/reference/createactorhooks) — Creating actor hooks
- [React Setup](/v3/react-setup) — Complete React configuration
