...
| `identity`         | `Identity \| null`            | The current user's `@dfinity/agent` Identity      |
| `principal`        | `Principal \| null`           | The current user's `@dfinity/principal` Principal |
...
- [createAuthHooks](/reference/createauthhooks) — Auth hooks factory
- [useUserPrincipal](/reference/createauthhooks/useuserprincipal) — Get current principal
- [useAgentState](/reference/createauthhooks/useagentstate) — Monitor agent state
