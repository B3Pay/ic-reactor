...
- [useUserPrincipal](/v4/reference/createauthhooks/useuserprincipal) — Get current principal
- [useAgentState](/v4/reference/createauthhooks/useagentstate) — Monitor agent state
