...
- [useActorMethod](/v4/reference/createactorhooks/useactormethod) — Bound version
- [useReactorQuery](/v4/reference/reactorhooks/usereactorquery)
- [useReactorMutation](/v4/reference/reactorhooks/usereactormutation)
