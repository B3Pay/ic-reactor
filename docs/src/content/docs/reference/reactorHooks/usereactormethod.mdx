...
| :--------------- | :-------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------- |
| `data`           | `ReactorQueryData<ReactorReturnOk<A, M, T>> \| undefined` | The returned data. A method's `undefined` result is `null`, as in `useReactorQuery`, so `undefined` only means no call has settled yet.    |
