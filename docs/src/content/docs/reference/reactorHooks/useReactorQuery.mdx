...
Same as [useActorQuery](/v4/reference/createactorhooks/useactorquery).
...
- [useActorQuery](/v4/reference/createactorhooks/useactorquery) — Bound version
- [useReactorSuspenseQuery](/v4/reference/reactorhooks/usereactorsuspensequery) — Suspense version
