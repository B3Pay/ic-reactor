...
Same as [useActorQuery](/reference/createactorhooks/useactorquery).
...
- [useActorQuery](/reference/createactorhooks/useactorquery) — Bound version
- [useReactorSuspenseQuery](/reference/hooks/reactorhooks/usereactorsuspensequery) — Suspense version
