...
Same as [useActorInfiniteQuery](/v4/reference/createactorhooks/useactorinfinitequery).

## See Also

- [useActorInfiniteQuery](/v4/reference/createactorhooks/useactorinfinitequery) — Bound version
