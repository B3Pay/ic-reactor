...
Same as [useActorInfiniteQuery](/reference/createactorhooks/useactorinfinitequery).

## See Also

- [useActorInfiniteQuery](/reference/createactorhooks/useactorinfinitequery) — Bound version
