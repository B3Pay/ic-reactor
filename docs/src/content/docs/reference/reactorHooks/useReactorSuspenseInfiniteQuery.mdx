...
Same as [useActorSuspenseInfiniteQuery](/reference/createactorhooks/useactorsuspenseinfinitequery).

## See Also

- [useActorSuspenseInfiniteQuery](/reference/createactorhooks/useactorsuspenseinfinitequery) — Bound version
