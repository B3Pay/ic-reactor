...
Same as [useActorSuspenseInfiniteQuery](/v4/reference/createactorhooks/useactorsuspenseinfinitequery).

## See Also

- [useActorSuspenseInfiniteQuery](/v4/reference/createactorhooks/useactorsuspenseinfinitequery) — Bound version
