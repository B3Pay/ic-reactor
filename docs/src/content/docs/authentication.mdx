...
- [useAgentState](/reference/createauthhooks/useagentstate) — Agent state reference
- [React Setup](/react-setup) — Complete React configuration
- [Error Handling](/error-handling) — Handle auth and query errors
- [Query Caching](/query-caching) — Understand query invalidation
