...
- [useAgentState](/ic-reactor/v3/reference/createauthhooks/useagentstate) — Agent state reference
- [React Setup](/ic-reactor/v3/react-setup) — Complete React configuration
- [Error Handling](/ic-reactor/v3/error-handling) — Handle auth and query errors
- [Query Caching](/ic-reactor/v3/query-caching) — Understand query invalidation
