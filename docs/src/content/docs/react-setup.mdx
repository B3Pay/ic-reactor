...
2. ### Create Hooks
   ...
   export const {
     useActorQuery, // [Read more](/v3/reference/createactorhooks/useactorquery)
     useActorMutation, // [Read more](/v3/reference/createactorhooks/useactormutation)
     useActorSuspenseQuery, // [Read more](/v3/reference/createactorhooks/useactorsuspensequery)
     useActorInfiniteQuery, // [Read more](/v3/reference/createactorhooks/useactorinfinitequery)
   } = createActorHooks(backend)

   // Auth hooks for authentication
   export const {
     useAuth, // [Read more](/v3/reference/createauthhooks/useauth)
     useUserPrincipal, // [Read more](/v3/reference/createauthhooks/useuserprincipal)
     useAgentState, // [Read more](/v3/reference/createauthhooks/useagentstate)
...
A convenience hook for getting the current user's [`useUserPrincipal`](/v3/reference/createauthhooks/useuserprincipal):
...
export const {
  useActorQuery: useLedgerQuery, // [Read more](/v3/reference/createactorhooks/useactorquery)
  useActorMutation: useLedgerMutation, // [Read more](/v3/reference/createactorhooks/useactormutation)
} = ledgerHooks

export const {
  useActorQuery: useBackendQuery, // [Read more](/v3/reference/createactorhooks/useactorquery)
  useActorMutation: useBackendMutation, // [Read more](/v3/reference/createactorhooks/useactormutation)
} = backendHooks
