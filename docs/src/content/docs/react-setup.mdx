...
2. ### Create Hooks
   ...
   export const {
     useActorQuery, // [Read more](/reference/createactorhooks/useactorquery)
     useActorMutation, // [Read more](/reference/createactorhooks/useactormutation)
     useActorSuspenseQuery, // [Read more](/reference/createactorhooks/useactorsuspensequery)
     useActorInfiniteQuery, // [Read more](/reference/createactorhooks/useactorinfinitequery)
   } = createActorHooks(backend)

   // Auth hooks for authentication
   export const {
     useAuth, // [Read more](/reference/createauthhooks/useauth)
     useUserPrincipal, // [Read more](/reference/createauthhooks/useuserprincipal)
     useAgentState, // [Read more](/reference/createauthhooks/useagentstate)
...
The [`useAuth`](/reference/createauthhooks/useauth) hook provides login and logout functionality:
...
For accessing the [`useAgentState`](/reference/createauthhooks/useagentstate) connection state:
...
A convenience hook for getting the current user's [`useUserPrincipal`](/reference/createauthhooks/useuserprincipal):
...
export const {
  useActorQuery: useLedgerQuery, // [Read more](/reference/createactorhooks/useactorquery)
  useActorMutation: useLedgerMutation, // [Read more](/reference/createactorhooks/useactormutation)
} = ledgerHooks

export const {
  useActorQuery: useBackendQuery, // [Read more](/reference/createactorhooks/useactorquery)
  useActorMutation: useBackendMutation, // [Read more](/reference/createactorhooks/useactormutation)
} = backendHooks
...
6. **Use Suspense boundaries** — Wrap components using [`useActorSuspenseQuery`](/reference/createactorhooks/useactorsuspensequery) in `<Suspense>`
