 ...
 * next. `AuthenticationManager` holds mutable identity state too, so a shared
 * one carries one visitor's sign-in into another's request. (The auth hooks
 * themselves render a fixed signed-out state on the server.)
 *
