...
function isLegacyGeneratedIndexFile(content: string): boolean {
  // Old `index.ts` shapes produced by earlier codegen runs that should be
  // migrated to the new `export * from "./generated"` wrapper:
  //  - a fully generated reactor index (hooks + Auto-generated banner), or
  //  - the previous managed wrapper that re-exported `./index.generated`.
  return (
