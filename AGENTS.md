...
- `@ic-reactor/core` (`packages/core`, `3.11.0`) — core runtime, `ClientManager`, `Reactor`, `DisplayReactor`, cache integration.
...
- Keep package-specific docs aligned with the released v3.11.0 runtime and its published tooling.
